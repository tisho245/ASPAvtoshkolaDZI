        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificationDesc = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTheoryHours = table.Column<int>(type: "int", nullable: false),
                    TotalPracticeHours = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTheoryHours = table.Column<int>(type: "int", nullable: false),
                    CurrentPracticeHours = table.Column<int>(type: "int", nullable: false),
                    ClientId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseInstances", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseInstances_CourseInstanceId",
                table: "StudentCourseInstances",
                column: "CourseInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseInstances_VehicleId",
                table: "StudentCourseInstances",
                column: "VehicleId");
